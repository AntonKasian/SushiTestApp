...
//    }()
    ...
    override func layoutSubviews() {
        ...
        weightLabel.frame = CGRect(x: priceLabel.frame.width - 10, y: descriptionLabel.frame.maxY + 25, width: frame.width / 2 - 20, height: 20)

        flameImageView.frame = CGRect(x: weightLabel.frame.maxX + 20, y: priceLabel.frame.minY, width: 20, height: 20)
